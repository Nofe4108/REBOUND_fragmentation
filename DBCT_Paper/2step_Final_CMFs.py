...
ax1.scatter(final_masses, final_cmfs, s=5.0, color = 'black', zorder=1)
ax1.axhline(0.304, label = 'Initial Average CMF', color = 'firebrick', linestyle = '--', alpha=.7, zorder=2)
ax1.axvline(.093, label = 'Embryo Mass', color = 'royalblue', linestyle = ':', alpha=.7, zorder=2)
ax1.axvline(.0093, label = 'Planetesimal Mass', color = 'goldenrod', linestyle = '-.', alpha=.7, zorder=2)
...
ax1.grid(alpha=0.7)
plt.legend()
plt.savefig("graphs/2step_Final_CMFs.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/2step_Final_CMFs.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/2step_Final_CMFs.png', bbox_inches='tight', dpi=300)