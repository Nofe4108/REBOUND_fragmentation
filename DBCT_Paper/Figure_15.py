"""
Produces Figure 15 from Ferich et al. (IN PREP)
"""
...
# File Pathways
comp_output_file_pw = "DBCT_output/3step_0.5_DBCT_output"
...
ax1.axhline(0.494, label = 'Initial CMF', color = 'tab:blue', linestyle = '--', alpha=.7)
...
ax1.grid(alpha=0.7)
plt.legend()
plt.savefig("graphs/fig15.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig15.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig15.png', bbox_inches='tight', dpi=300)
