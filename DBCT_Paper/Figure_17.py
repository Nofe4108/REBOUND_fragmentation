"""
Produces Figure 17 from Ferich et al. (IN PREP)
"""
...
# File pathways
comp_output_file_pw = "DBCT_output/reversed_3step_DBCT_output"
...
ax1.axhline(0.306, label = 'Initial CMF', color = 'tab:blue', linestyle = '--', alpha=.7)
...
ax1.grid(alpha=0.7)
plt.legend()
plt.savefig("graphs/fig17.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig17.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig17.png', bbox_inches='tight', dpi=300)