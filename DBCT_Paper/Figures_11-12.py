...
plt.savefig("graphs/fig11.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig11.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig11.png', bbox_inches='tight', dpi=300)
...
ax1.set_ylim([0.225, 0.375])
ax1.legend(loc='lower right')
plt.savefig("graphs/fig12.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig12.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig12.png', bbox_inches='tight', dpi=300)
