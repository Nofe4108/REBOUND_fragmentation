...
plt.savefig("graphs/fig5.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig5.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/fig5.png', bbox_inches='tight', dpi=300)
