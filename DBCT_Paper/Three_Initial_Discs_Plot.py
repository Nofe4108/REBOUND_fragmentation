...
cbar.minorticks_on()
plt.savefig("graphs/Three_Initial_Discs.pdf", bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/Three_Initial_Discs.eps', bbox_inches='tight', pad_inches=0.01)
plt.savefig('graphs/Three_Initial_Discs.png', bbox_inches='tight', dpi=300)
