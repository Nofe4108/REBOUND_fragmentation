...
"""
This is the version of the composition tracking code
found in Childs and Steffen (2022) that is designed to produce
data for plots in Ferich et al. (IN PREP)
"""
...
comp_input_file_pw = "DBCT_input/exp_DBCT_input"
ejec_file_pw = "ejections/ejections"
output_file_pw = "CT_C&S_2022_output/exp_CT_output"
...
for i in file_range:
    ...
    comp_input_file = comp_input_file_pw + ".txt"
