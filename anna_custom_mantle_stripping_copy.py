...
collision_file = "/Users/nferich/Desktop/anna_collision_reports/new_collision_reports/new_collision_report1.txt"
comp_input_file = "/Users/nferich/Desktop/anna_collision_reports/mantle_stripping_input/differentiated_mantle_stripping_input1.txt"
impact_param_file = "impact_parameters/impact_parameters1.txt"
ejec_file = "ejections/ejections1.txt"
output_file = "mantle_stripping_output/custom_mantle_stripping_output1.txt"
...
for i in min_core_collision_fracs:
    ...
    for j in max_core_collision_fracs:
        if j >= i: #ensures the max collision frac is never less than the minimum
            final_composition = track_composition(collision_file, comp_input_file, impact_param_file, ejec_file, i, j)
    ...
    final_compositions.append(average_fracs)
