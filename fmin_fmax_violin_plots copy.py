...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 12:34:00 2023
...
ax1.axhline(0.3, label = 'Initial CMF', color = 'tab:orange', linestyle = '-', alpha=.6)
fig1 = plt.violinplot(all_final_core_fracs, showmedians=True, widths=0.7)
...
plt.xlabel('$f_{min}$', fontsize='x-large')
plt.ylabel('Final Planet CMF', fontsize='large')
plt.title('$f_{max}$ = 1.0', fontsize='x-large')
ax1.minorticks_on()
...
ax2.axhline(0.3, label = 'Initial CMF', color = 'tab:orange', linestyle = '-', alpha=.6)
fig2 = plt.violinplot(all_final_core_fracs, showmedians=True, widths=0.7)
plt.grid(color='black', linestyle='-', axis='y')
...
ax2.set_ylim([0.225, 0.375])
plt.xlabel('$f_{max}$', fontsize='x-large')
plt.ylabel('Final Planet CMF', fontsize='large')
plt.title('$f_{min}$ = 0.0', fontsize='x-large')
ax2.minorticks_on()
