...
fig2 = plt.errorbar(max_core_collision_fracs, final_average_core_fracs[0], yerr=[min_bars, max_bars], fmt='o', color = 'black', capsize=5)
plt.grid(color='black', linestyle='-', axis='y')
plt.xticks(np.arange(0.0, 1.1, 0.1))
plt.yticks(np.arange(0.00, 0.85, 0.05))
plt.ylim([0.0, 0.8])
ax2.axhline(0.3, label = 'Initial CMF', color = 'tab:blue', linestyle = '-', alpha=1.0)
